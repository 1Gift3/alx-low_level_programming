...
/**
 * advanced_binary_recursive - Searches extensively for value in a sorted
 *                             array of integers using binary search.
 * @array: A pointer to the first element of [sub]array to search.
 ...
 * @value: The value to search for.
 *
 * Return: That if value is not present or the array is NULL, -1.
